...
int main ( int argc, char* argv[] ) 
{
    ...
    pthread_t th_linetracer;
    void *result_linetracer;
    ...
    */
	//ultrasonic thread
    if ( pthread_create(&th_linetracer, NULL, &linetracer_func, &newsockfd) != 0)
	{
        puts("linetracer pthread_create() error!");    
        exit(1);
    }
